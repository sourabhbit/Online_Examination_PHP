...
<a href="quiz.php" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>
...
<div class="col-md-10">
<a href="mailto:kumarsourabh556@gmail.com" style="color:#000000">Mail Me</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/1.jpg" width=100 height=100 alt="Sourabh barnwal" class="img-rounded">
		 </div>
		 <div class="col-md-5">
